...
const passenger = {
    ...
    // },
    // delcustomer_data(data, fn, errFn) {
    //     ajax.call(this, 'post', "http://localhost:9000/customerinfo/delcustomer_data", data, fn, errFn);
    // },
    ...
    // },
    // delcustomer_data(data, fn, errFn) {
    //     ajax.call(this, 'post', "http://193.112.112.22:9000/customerinfo/delcustomer_data", data, fn, errFn);
    // },
    ...
    // },
    // delcustomer_data(data, fn, errFn) {
    //     ajax.call(this, 'post', "http://192.168.23.1:9000/customerinfo/delcustomer_data", data, fn, errFn);
    // },
    ...
    delcustomer_data(data, fn, errFn) {
        ajax.call(this, 'post', "http://192.168.43.21:9000/customerinfo/delcustomer_data", data, fn, errFn);
    },
